...
export default function LoginPage() {
    ...
    //                 <p className="text-sm text-charcoal/60 mb-6">We sent a sign-in link to <strong>{identifier}</strong>.</p>
            ...
            <div className="bg-white rounded-lg shadow-md w-full max-w-sm p-8">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        <label className="text-sm font-medium text-charcoal">Username or Email</label>
                        <input type="text" value={identifier} onChange={e => setIdentifier(e.target.value)} required className="border border-charcoal/20 rounded px-3 py-2 text-sm" />
                    </div>

                    {/* {mode === 'password' && ( */}
                    <div className="flex flex-col gap-1">
                        <label className="text-sm font-medium text-charcoal">Password or PIN</label>
