    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                   ...
                   .authorizeHttpRequests(auth -> auth
                           ...
                           .requestMatchers(HttpMethod.POST, "/incident-charges/*/approve").hasAnyRole("ADMIN", "MANAGER")
                           .requestMatchers(HttpMethod.POST, "/incident-charges/*/reject").hasAnyRole("ADMIN", "MANAGER")
                           .requestMatchers("/pos-devices/**").hasRole("ADMIN")
