...
public class QuickBooksAuthService {
    ...
    public QuickBooksTokenResponse exchangeCodeForTokens(String code, String redirectUri) {
        return requestToken("grant_type=authorization_code&code=" + urlEncode(code) + "&redirect_uri=" + urlEncode(redirectUri));
    }
    ...
    public String getAccessToken() {
        ...
        try {
            ...
            QuickBooksTokenResponse response = requestToken("grant_type=refresh_token&refresh_token=" + urlEncode(connection.refreshToken().value()));
    ...
    private QuickBooksTokenResponse requestToken(String formBody) {
